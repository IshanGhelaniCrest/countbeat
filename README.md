...
`${GOPATH}/src/github.com/IshanGhelaniCrest/countbeat`
...
```
git remote set-url origin https://github.com/IshanGhelaniCrest/countbeat
...
```
mkdir -p ${GOPATH}/src/github.com/IshanGhelaniCrest/countbeat
git clone https://github.com/IshanGhelaniCrest/countbeat ${GOPATH}/src/github.com/IshanGhelaniCrest/countbeat
```
